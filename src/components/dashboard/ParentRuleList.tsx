...
import { Plus, ShieldAlert, Star, MoreVertical, Pencil, Trash2 } from "lucide-react";
...
export default function ParentRuleList() {
  ...
  return (
    <>
      <Card id="section-rules" className="shadow-card mt-0">
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="text-lg flex items-center gap-2 min-w-0">
            <ShieldAlert className="h-5 w-5 text-destructive flex-shrink-0" />
            <span className="break-words whitespace-normal leading-tight">{t("penalties.rules")}</span>
          </CardTitle>
